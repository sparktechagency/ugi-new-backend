...
const bookingServiceSchema = new Schema<TServiceBooking>(
  {
    ...
    cencelationParsentage: { type: Number, required: false, default: null },
    cencelationAmount: { type: Number, required: false, default: null },
    cencelationHours: { type: String, required: false, default: null },
    refundStatus: {
      type: String,
      required: false,
